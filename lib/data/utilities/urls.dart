import 'package:task_manager_app/data/utilities/task_status.dart';
...
class Urls {
  ...
  static String taskStatusUpdateUrl(String id, String taskStatus) =>
      '$_baseUrl/updateTaskStatus/$id/$taskStatus';

  static String newTasksListUrl =
      '$_baseUrl/listTaskByStatus/${TaskStatus.newTask}';
  static String completedTasksListUrl =
      '$_baseUrl/listTaskByStatus/${TaskStatus.completedTask}';
  static String progressTasksListUrl =
      '$_baseUrl/listTaskByStatus/${TaskStatus.progressTask}';
  static String canceledTasksListUrl =
      '$_baseUrl/listTaskByStatus/${TaskStatus.canceledTask}';
