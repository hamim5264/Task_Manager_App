...
import 'package:task_manager_app/data/utilities/theme_utility.dart';
import 'package:task_manager_app/ui/screens/splash_screen.dart';
import 'package:task_manager_app/ui/state_managers/controller_binding.dart';
...
class _TaskManagerAppState extends State<TaskManagerApp> {
  ...
  ThemeData _lightThemeData(BuildContext context) {
    return ThemeData(
        ...
        iconTheme: IconThemeData(color: mainColor.shade300, size: 30),
        listTileTheme: ListTileThemeData(
            iconColor: mainColor.shade300, horizontalTitleGap: 3.0),
  ...
  ThemeData _darkThemeData(BuildContext context) {
    return ThemeData(
        ...
        iconTheme: IconThemeData(color: mainColor.shade100, size: 30),
        listTileTheme: ListTileThemeData(
            iconColor: mainColor.shade300, horizontalTitleGap: 3.0),
        ...
        progressIndicatorTheme:
            ProgressIndicatorThemeData(color: mainColor.shade300),
